...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.MazeCem.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        {
            Leaderboards.MazeCem.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.MazeCem.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
